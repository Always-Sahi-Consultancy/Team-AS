...
$(document).ready(function () {
  ...
  $(".night").on("click", function () {
    ...
    if (state2 == 1) {
      ...
      header_data.style.backgroundImage =
        "url(image/patrick-fore-HVFYFns30-I-unsplash.jpg)";
      ...
      header_data.style.backgroundImage =
        "url(image/zhengtao-tang-ltpQwpxObs8-unsplash.jpg)";
