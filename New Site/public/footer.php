<footer class="footer">
    ...
    <div class="documentation">
        <div class="documentation__option"><a href="#" class="documentation__link">Terms of use</a></div>
        <div class="documentation__option"><a href="#" class="documentation__link">Earning Disclaimer</a></div>
